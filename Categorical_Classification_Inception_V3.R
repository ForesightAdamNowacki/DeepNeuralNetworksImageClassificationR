...
models_store_dir <- "D:/GitHub/DeepNeuralNetworksRepoR/Inception_V3/Categorical"
...
optimal_model_repo_dir <- base::paste(models_repo_store_dir, "Categorical_Inception_V3_Model.hdf5", sep = "/")
