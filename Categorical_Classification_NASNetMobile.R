...
models_store_dir <- "D:/GitHub/DeepNeuralNetworksRepoR/NASNetMobile/Categorical"
...
optimal_model_repo_dir <- base::paste(models_repo_store_dir, "Categorical_NASNetMobile_Model.hdf5", sep = "/")
