...
readr::write_csv(tibble::as_tibble(train_probabilities), "Xception_train_binary_probabilities.csv")
readr::write_csv(tibble::as_tibble(validation_probabilities), "Xception_validation_binary_probabilities.csv")
readr::write_csv(tibble::as_tibble(test_probabilities), "Xception_test_binary_probabilities.csv")
