...
models_store_dir <- "D:/GitHub/DeepNeuralNetworksRepoR/Inception_ResNet_V2/Categorical"
...
optimal_model_repo_dir <- base::paste(models_repo_store_dir, "Categorical_Inception_ResNet_V2_Model.hdf5", sep = "/")
