...
models_store_dir <- "D:/GitHub/DeepNeuralNetworksRepoR/MobileNet_V2/Categorical"
...
optimal_model_repo_dir <- base::paste(models_repo_store_dir, "Categorical_MobileNet_V2_Model.hdf5", sep = "/")
