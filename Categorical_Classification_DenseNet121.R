...
models_store_dir <- "D:/GitHub/DeepNeuralNetworksRepoR/DenseNet121/Categorical"
...
optimal_model_repo_dir <- base::paste(models_repo_store_dir, "Categorical_DenseNet121_Model.hdf5", sep = "/")
